...
{
	public static class BattleDashClientAudioEvents
	{
		...
		public static void RaiseTriggerMuteUnMuteEvent()
		{
			if (_triggerMuteUnMute == null){
				LoggerService.LogWarning($"{nameof(BattleDashClientAudioEvents)}::{nameof(RaiseTriggerMuteUnMuteEvent)} raised, but nothing picked it up");
				return;
			}
		...
		public static void RaiseFadeInMusicEvent(AudioClip music)
		{
			if (_fadeInMusic == null){
				LoggerService.LogWarning($"{nameof(BattleDashClientAudioEvents)}::{nameof(RaiseFadeInMusicEvent)} raised, but nothing picked it up");
				return;
			}
		...
		public static void RaiseFadeOutMusicEvent(float duration)
		{
			if (_fadeOutMusic == null){
				LoggerService.LogWarning($"{nameof(BattleDashClientAudioEvents)}::{nameof(RaiseFadeOutMusicEvent)} raised, but nothing picked it up");
				return;
			}
		...
		{
			if (_playSfx == null){
				LoggerService.LogWarning($"{nameof(BattleDashClientAudioEvents)}::{nameof(RaisePlaySfxEvent)} raised, but nothing picked it up");
				return;
			}
