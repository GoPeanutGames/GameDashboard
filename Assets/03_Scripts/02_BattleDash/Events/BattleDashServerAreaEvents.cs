...
{
    public static class BattleDashServerAreaEvents
    {
        ...
        public static void RaiseAreaDistancePassedPercUpdatedEvent(float perc)
        {
            if (_areaDistancePassedPercUpdated == null){
                LoggerService.LogWarning($"{nameof(BattleDashServerAreaEvents)}::{nameof(RaiseAreaDistancePassedPercUpdatedEvent)} raised, but nothing picked it up");
                return;
            }
        ...
        public static void RaiseAreaSpawnDoorEvent()
        {
            if (_areaSpawnDoor == null){
                LoggerService.LogWarning($"{nameof(BattleDashServerAreaEvents)}::{nameof(RaiseAreaSpawnDoorEvent)} raised, but nothing picked it up");
                return;
            }
        ...
        public static void RaiseAreaSpawnNextAreaEvent()
        {
            if (_areaSpawnNextArea == null){
                LoggerService.LogWarning($"{nameof(BattleDashServerAreaEvents)}::{nameof(RaiseAreaSpawnNextAreaEvent)} raised, but nothing picked it up");
                return;
            }
