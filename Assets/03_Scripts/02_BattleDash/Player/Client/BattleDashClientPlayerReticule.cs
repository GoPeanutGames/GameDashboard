...
{
	public class BattleDashClientPlayerReticule : MonoBehaviour
	{
		...
		{
			BattleDashClientActionEvents.OnUpdatePlayerVisualPosition += OnUpdatePlayerVisualPosition;
			BattleDashClientActionEvents.OnMobilePlayerTouchShootPosition += OnMobileShootPositionChanged;
		}
		...
		private void ProcessReticule()
		{
			...
			BattleDashClientActionEvents.RaiseUpdatePlayerAimEvent(target);
		}
#endif
	}
}